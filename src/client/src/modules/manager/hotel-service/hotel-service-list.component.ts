...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, HotelServiceDetailsComponent, ReactiveFormsModule, FontAwesomeModule],
...
export class HotelServiceListComponent implements OnInit{
  ...
  public onSubmit() {
    ...
    this.apiUrl = `http://localhost:8080/api/v1/hotel-serivces/searchByHotelServiceName?keyword=${this.searchForm.value.keyword}`;
    this.search();
  }
